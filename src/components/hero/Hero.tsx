        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/request-demo"
                className="rounded-full bg-green-500 px-8 py-4 font-semibold text-black transition hover:bg-green-400 hover:shadow-lg hover:shadow-green-500/20"
              >
                Request Demo
              </Link>
              ...
              <Link
                href="/product"
                className="rounded-full border border-white/20 px-8 py-4 text-white transition hover:border-green-500 hover:text-green-400"
              >
                Explore Product
              </Link>
            </div>
